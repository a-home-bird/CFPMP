...
class Recommender(object):
    def __init__(self, conf, training_set, test_set,dev_set, **kwargs):
        self.config = conf
        self.data = Data(self.config, training_set, test_set,dev_set)
    ...
    def execute(self):
        ...
        rec_list_test = self.test()
        rec_list_dev = self.dev()
        print('Evaluating...')
        test_P = self.evaluate(rec_list_test,rec_list_dev)
        return test_P
